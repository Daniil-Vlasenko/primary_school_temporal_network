...
data1 содержит информацию о том, когда (time) кто с кем (i, j) контактировал и из какого они класса или являются ли учителем (Ci, Cj). data2 содержит дополнительную информацию о поле учеников. 
